...
C = src/asciiPrint.c src/object.c src/misc.c src/inventory.c  src/location.c src/match.c src/toggle.c src/combat.c src/torch.c src/execute.c src/main.c
H = src/asciiPrint.h src/object.h src/misc.h src/inventory.h  src/location.h src/match.h src/toggle.h src/combat.h src/torch.h src/execute.h
