...
#define centralVaults	(objs + 31)
#define intoCentralVaults	(objs + 32)
#define exitCentralVaultsStaircase	(objs + 33)
#define witchesLair	(objs + 34)
#define openDoorToWitchesLair	(objs + 35)
#define closedDoorToWitchesLair	(objs + 36)
#define openDoorToCentralVaults	(objs + 37)
#define closedDoorToCentralVaults	(objs + 38)
#define tortureChamber	(objs + 39)
#define intoTortureChamber	(objs + 40)
#define exitTortureChamber	(objs + 41)
#define deepCentralVaults	(objs + 42)
#define intoDeepCentralVaults	(objs + 43)
#define intoDeepCentralVaultsBlocked	(objs + 44)
#define exitDeepCentralVaults	(objs + 45)
...
#define oldIronKey	(objs + 63)
#define torch	(objs + 64)
#define cauldron	(objs + 65)
#define bookArsGoetia	(objs + 66)
